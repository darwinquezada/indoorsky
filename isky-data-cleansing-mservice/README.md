...
| ---------------- | --------------------------------------------------------------------------------------------------- |
    ...
    │   ├── algorithms
    │   │   ├── data_cleansing.py                   # Data cleansing algorithm   
    │   │   ├── data_partition.py                   # Data partition
    │   │   ├── knn_positioning.py                  # KNN Algorithm    
    │   │   └── process.py                          # Data cleansing process                     
    │   ├── core                                    # Util resources
    │   │   ├── decorators
